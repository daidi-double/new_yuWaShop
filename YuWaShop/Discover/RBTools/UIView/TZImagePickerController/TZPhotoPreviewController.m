...
- (void)configCustomNaviBar {
    _naviBar = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.tz_width, 44)];
    _naviBar.backgroundColor = [UIColor whiteColor];
    _naviBar.alpha = 1.f;
    UIView * lineView = [[UIView alloc]initWithFrame:CGRectMake(0.f, _naviBar.height - 1.f, [UIScreen mainScreen].bounds.size.width, 1.f)];
    ...
    _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.tz_width - 44, 0, 42, 42)];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGFloat rgb = 253 / 255.0;
    cell.backgroundColor = [UIColor colorWithRed:rgb green:rgb blue:rgb alpha:1.0];
    return cell;
}
